...
public class Lesson1 {
    ...
    double b = sc.nextInt();
        ...
        if(b==0){
            System.out.println("Thuong a / b = Math Error");
        } else { 
        ...
        if( x==0 ){
            System.out.println("Dieu kien ptb2 a khac 0");
        } else{     
        ...
        System.out.print("Nhap vao 1 so nguyen bat ki m = ");
        int m = sc.nextInt();
        System.out.println("Cac so nguyen to nho hon m la ");
        for(int i = m ; i > 0 ; i -- ){
            ...
            if (k == 1 && i != m && i != 1) System.out.println("i = " + i);
    }
